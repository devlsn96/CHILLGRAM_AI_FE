...
import { Package, Instagram, Youtube, Wand2 } from "lucide-react";
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="mt-8 flex items-center justify-center gap-4 lg:justify-start">
                  ...
                  <p className="text-sm font-medium text-gray-400">
                    이미 <span className="text-gray-900 font-bold">1,200+</span>
                    개의 브랜드가 사용 중입니다.
                  </p>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="col-span-2 p-5 rounded-2xl bg-gradient-to-br from-indigo-50 to-blue-50 border border-blue-100 relative group overflow-hidden shadow-sm hover:shadow-md transition-all">
                        <div className="flex justify-between items-start mb-2">
                          <span className="text-[10px] font-bold text-indigo-600 bg-white/80 backdrop-blur px-2 py-1 rounded-full shadow-sm">
                            AI Package Design
                          </span>
                        ...
                        <p className="text-center text-xs text-indigo-800 font-medium mt-2">
                          "여름 시즌 한정 패키지"
                        </p>
                      </div>
          ...
          <Container>
            <div className="mb-16 text-center">
              <h2 className="text-3xl font-black text-gray-900 md:text-4xl">
                비즈니스에 필요한
                <br className="md:hidden" /> 모든 기능을 하나로.
              </h2>
              ...
              <div className="mt-8 md:mt-0 md:w-1/2 flex justify-end">
                ...
                <div className="flex items-end gap-2 h-32 w-full max-w-sm">
                  ...
                  <div className="w-1/5 bg-blue-600 rounded-t-lg h-[90%] relative">
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black text-white text-xs font-bold px-2 py-1 rounded">
                      Best
                    </div>
                  </div>
                </div>
          ...
          <Container>
            <div className="mx-auto max-w-2xl text-center mb-16">
              <h2 className="text-3xl font-black text-gray-900">
                4단계로 완성되는
                <br className="md:hidden" /> 초간단 워크플로우
              </h2>
              <p className="mt-4 text-gray-500">
